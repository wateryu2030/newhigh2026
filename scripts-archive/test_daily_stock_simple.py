        ...
        async def mock_ai_analysis(market_data):
            ...
            return {
                ...
                "recommendations": {
                    ...
                    "analysis": {"market_sentiment": "中性偏积极", "risk_level": "中等"},
                },
                "status": "success",
            }
        ...
        async def mock_send_notification(analysis_results):
            ...
            if top_picks:
                ...
                for i, pick in enumerate(top_picks, 1):
                    ...
                    print(
                        f"   操作: {pick.get('action')} (置信度: {pick.get('confidence', 0):.0%})"
                    )
            ...
            return {"status": "success", "channel": "console", "timestamp": "2026-03-13T09:17:00"}
